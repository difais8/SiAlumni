...
<head>
    ...
    <title>@yield('title', 'Dashboard Alumni') - SiAlumni</title>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    {{-- 2. Direktori Alumni --}}
                    <li class="nav-item {{ request()->routeIs('alumni.direktori.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('alumni.direktori.index') }}">
                            <i class="mdi mdi-account-group-outline menu-icon"></i>
                            <span class="menu-title">Direktori Alumni</span>
                        </a>
                    </li>
